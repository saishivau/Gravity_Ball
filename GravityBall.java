...
public class GravityBall extends Applet implements Runnable,MouseMotionListener,KeyListener {
	...
	public void PaintIntro(Graphics g) {
		...
		if (player1 == true) {
		 ...
		 g.drawString("Welcome",getSize().width/2 - 45,getSize().height/2 + getSize().height/3);
		 g.setColor(Color.white);
		 g.drawString("Press Space to Start !!",getSize().width/2 - 45,getSize().height/2 + 15 + getSize().height/3);
		} else { 
		 g.setColor(Color.white);
		 g.drawString("Welcome",getSize().width/2 - 45,getSize().height/2 + getSize().height/3);
		 g.setColor(Color.blue);
		...
		g.drawString("Have a Great Play",getSize().width/2 - 90,getSize().height/7 + 110);
	}
	...
	public void PaintGame2(Graphics g) {
	 ...
	 if (gameover == true) {
			...
			g.drawImage(gameoverpic,getSize().width / 2 - 48
						 ,getSize().height / 2 - 20,this);
			if (ball2.y == -7) g.drawString("",getSize().width / 2 - 40 ,getSize().height); 
			if (ball2.y == getSize().height - 19) g.drawString("",getSize().width / 2 - 40 ,getSize().height); 
	 }	
	}	
